...
BOSSES = {
    ...
    'illidan':     dict(name='Illidan Stormrage',     hp=30000,   days=3,  unlock_kills=10, unlock_lvl=7, unlock_bld=[], fee=1500,  loot=['epic','rare','rare','uncommon'],                            gold_r=4000,  lumber_r=1200,  atk_min=2, atk_max=6),
    'mannoroth':   dict(name='Pit Lord Mannoroth',    hp=40000,   days=4,  unlock_kills=15, unlock_lvl=8, unlock_bld=['citadel'], fee=3000, loot=['epic','rare','rare','uncommon','common','common'],    gold_r=10000, lumber_r=3000,  atk_min=2, atk_max=9),
    ...
    'lich_king':   dict(name='The Lich King',         hp=1000000, days=14, unlock_kills=30, unlock_lvl=9, unlock_bld=['citadel'], fee=10000, loot=['legendary','epic','epic'], gold_r=50000, lumber_r=15000, atk_min=4, atk_max=10),
}
