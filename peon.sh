...
ITEMS = {
    ...
    'storm_bolt':          ('Storm Bolt',             'uncommon',  'Deal 250 damage to active boss (consumable)'),
    'demolisher_shot':     ('Demolisher Shot',        'rare',      'Deal 500 damage to active boss (consumable)'),
    'thunder_clap':        ('Thunder Clap',           'rare',      'Deal 750 damage to active boss (consumable)'),
